...
window.addEventListener('click', () =>
{
    ...
    {
        switch(currentIntersected.object)
        {
            case object1:
...
const tick = () =>
{
    ...
    object3.position.y = Math.sin(elapsedTime*2) * .75
    ...
    // const rayNormalized = rayDirection.clone().normalize()

    // raycaster.set(rayOrigin, rayNormalized)
